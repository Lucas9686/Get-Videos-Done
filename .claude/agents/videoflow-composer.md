...
- List `public/assets/images/`, `public/assets/clips/`, `public/assets/audio/` to know what's available
...
If `public/assets/audio/vo-NN-timestamps.json` files exist (generated by the audio-producer with `timestamps: true`), use them for word-level subtitle overlays:
